...
int main()
{
	RenderWindow window(VideoMode(1300, 900), "Blackjack", Style::Titlebar | Style::Close);
	textBox bet;
	...
	t1.loadFromFile("../example3_images/2_of_clubs.png");
	t2.loadFromFile("../example3_images/2_of_diamonds.png");
	t3.loadFromFile("../example3_images/2_of_hearts.png");
	t4.loadFromFile("../example3_images/2_of_spades.png");

	t5.loadFromFile("../example3_images/3_of_clubs.png");
	t6.loadFromFile("../example3_images/3_of_diamonds.png");
	t7.loadFromFile("../example3_images/3_of_hearts.png");
	t8.loadFromFile("../example3_images/3_of_spades.png");

	t9.loadFromFile("../example3_images/4_of_clubs.png");
	t10.loadFromFile("../example3_images/4_of_diamonds.png");
	t11.loadFromFile("../example3_images/4_of_hearts.png");
	t12.loadFromFile("../example3_images/4_of_spades.png");

	t13.loadFromFile("../example3_images/5_of_clubs.png");
	t14.loadFromFile("../example3_images/5_of_diamonds.png");
	t15.loadFromFile("../example3_images/5_of_hearts.png");
	t16.loadFromFile("../example3_images/5_of_spades.png");

	t17.loadFromFile("../example3_images/6_of_clubs.png");
	t18.loadFromFile("../example3_images/6_of_diamonds.png");
	t19.loadFromFile("../example3_images/6_of_hearts.png");
	t20.loadFromFile("../example3_images/6_of_spades.png");

	t21.loadFromFile("../example3_images/7_of_clubs.png");
	t22.loadFromFile("../example3_images/7_of_diamonds.png");
	t23.loadFromFile("../example3_images/7_of_hearts.png");
	t24.loadFromFile("../example3_images/7_of_spades.png");

	t25.loadFromFile("../example3_images/8_of_clubs.png");
	t26.loadFromFile("../example3_images/8_of_diamonds.png");
	t27.loadFromFile("../example3_images/8_of_hearts.png");
	t28.loadFromFile("../example3_images/8_of_spades.png");

	t29.loadFromFile("../example3_images/9_of_clubs.png");
	t30.loadFromFile("../example3_images/9_of_diamonds.png");
	t31.loadFromFile("../example3_images/9_of_hearts.png");
	t32.loadFromFile("../example3_images/9_of_spades.png");

	t33.loadFromFile("../example3_images/10_of_clubs.png");
	t34.loadFromFile("../example3_images/10_of_diamonds.png");
	t35.loadFromFile("../example3_images/10_of_hearts.png");
	t36.loadFromFile("../example3_images/10_of_spades.png");

	t37.loadFromFile("../example3_images/ace_of_clubs.png");
	t38.loadFromFile("../example3_images/ace_of_diamonds.png");
	t39.loadFromFile("../example3_images/ace_of_hearts.png");
	t40.loadFromFile("../example3_images/ace_of_spades.png");

	t41.loadFromFile("../example3_images/jack_of_clubs.png");
	t42.loadFromFile("../example3_images/jack_of_diamonds.png");
	t43.loadFromFile("../example3_images/jack_of_hearts.png");
	t44.loadFromFile("../example3_images/jack_of_spades.png");

	t45.loadFromFile("../example3_images/king_of_clubs.png");
	t46.loadFromFile("../example3_images/king_of_diamonds.png");
	t47.loadFromFile("../example3_images/king_of_hearts.png");
	t48.loadFromFile("../example3_images/king_of_spades.png");

	t49.loadFromFile("../example3_images/queen_of_clubs.png");
	t50.loadFromFile("../example3_images/queen_of_diamonds.png");
	t51.loadFromFile("../example3_images/queen_of_hearts.png");
	t52.loadFromFile("../example3_images//queen_of_spades.png");

	t53.loadFromFile("../example3_images//cardBack.png");
	t54.loadFromFile("../example3_images/background1.png");
	t64.loadFromFile("../example3_images/background2.png");

	t55.loadFromFile("../example3_images/1.png");
	t56.loadFromFile("../example3_images/10.png");
	t57.loadFromFile("../example3_images/100.png");
	t58.loadFromFile("../example3_images/1000.png");
	t59.loadFromFile("../example3_images/max.png");

	t60.loadFromFile("../example3_images/double.png");
	t61.loadFromFile("../example3_images/hit.png");
	t62.loadFromFile("../example3_images/stand.png");
	t63.loadFromFile("../example3_images/place.png");
	t65.loadFromFile("../example3_images/deck.png");
